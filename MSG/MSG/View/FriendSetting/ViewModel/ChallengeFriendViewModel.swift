...
protocol ChallengeFriendOutput {
...
class ChallengeFriendViewModel: ObservableObject, ChallengeFriendInput, ChallengeFriendOutput {

    @Published var myFrinedArray: [Msg] = []
    @Published var text: String = ""
    @Published var notGamePlayFriend: [Msg] = []
    let friendUseCase = ChallengeFriendUseCase(repo: ChallengeFriendRepositoryImpl(dataSource: FirebaseService()))
